...
İçerik haritası kurmak teknik olarak basittir. Bir konu seçilir. O konuyla ilgili belgeler listelenir. Her belgeye kısa bir bağlam cümlesi eklenir. Harita bir giriş paragrafıyla çerçevelenir. Hedef, gereksiz süslemeden arınmış, bilgi yoğunluğu yüksek ve araştırmacının kasasını hem yapım anında hem de altı ay sonra kolayca okuyabileceği bir yapıdır. Yalnızca belgelerin listesi değil, kasanın görünür iskeleti.

## 5. Atomik Not, MOC, Meta-MOC Hiyerarşisi

İçerik haritaları tek bir düzeyde kalmaz. Bir hiyerarşi oluştururlar. Bu hiyerarşi üç katmanlıdır.
