...
Önceki broşür, etik çerçeveyi baştan kurulan bir iş akışı belgesi olarak tanımlamıştı. Bu broşür, o çerçevenin sınandığı en kritik ana geçer. Bir hakem yanıt mektubu, sosyal bilim araştırmacısının profesyonel üretiminin en yüksek bahisli metin türüdür. Yapılandırılmamış uzun bir cevap mektubu çoğunlukla ikinci bir red ile sonuçlanır. Bir izlenebilirlik matrisi, mektubu yönetir, yanıt kalitesini ve yayın kabul olasılığını artırır. Hedef, Claude Code ile bu matrisi yarı otomatik kuran ve yapay zeka ifşa etiğini koruyan bir iş akışı göstermektir.

## 1. Hakem Yanıt Mektubunun Yapısı

Bir hakem yanıt mektubu, dört zorunlu bileşenden oluşur. Birincisi, editöre kısa bir açılış. Revizyon için teşekkür, ana değişikliklerin özeti, ve mektubun yapısının bir cümleyle tanıtımı. İkincisi, her hakem yorumuna tek tek yanıt. Bir yorum, ardından yazarın yanıtı, ardından makalede yapılan değişikliğin tam yeri. Üçüncüsü, değişikliklerin makaledeki konumunun açık işaretlenmesi, sayfa ve satır düzeyinde. Dördüncüsü, kapanış, kalan açık noktaların dürüst kabulü.

Bu dört bileşen, bir disiplin gerektirir. Provenzale ve Stanley (2006), bir el yazmasını değerlendirmenin sistematik bir kılavuzunu sunarken, hakemlerin yorumlarının belirli kategorilere ayrıldığını gösterir. Yöntemsel, kavramsal, biçimsel. Yazarın yanıtı, her kategoriye uygun bir tonla verilmelidir. Noble (2017), hakemlere yanıt yazmanın on basit kuralını sıralarken, en kritik kuralın her yoruma açıkça ve ayrı ayrı yanıt vermek olduğunu belirtir. Yorumları gruplamak ya da atlamak, editörde yanıtın eksik olduğu izlenimini yaratır. Belcher (2019), akademik yayın sürecini on iki haftalık bir yapıya oturtan rehberinde, revizyon aşamasının makalenin kaderini belirleyen aşama olduğunu vurgular.
...
Matrisin neden gerekli olduğu, hakem değerlendirmesinin doğasından gelir. Bir makale, çoğunlukla iki ya da üç hakemden, her biri beş ila on yorum içeren değerlendirmeler alır. Bu, on beş ila otuz ayrı yoruma yanıt vermek demektir. Yapılandırılmamış bir mektupta, bu yorumların bazıları kaçınılmaz olarak gözden kaçar. Bir matris, bu kaçışı yapısal olarak imkansız kılar, çünkü her yorum bir satırdır ve her satırın bir yanıtı olmak zorundadır. Squazzoni ve diğerleri (2021), yüz kırk beş dergiyi inceledikleri çalışmalarında, hakem değerlendirme sürecinin yapısal özelliklerinin yayın sonucu üzerinde belirleyici olduğunu gösterir. Bir izlenebilirlik matrisi, bu yapısal sürece yazarın tarafından getirilen bir düzen aracıdır.

## 3. Claude Code ile Bir Matris Oluşturma

Bir izlenebilirlik matrisi, Claude Code ile yarı otomatik kurulabilir. İş akışı şu adımlardan oluşur. Önce hakem raporları, kasaya düz metin olarak alınır. Sonra her hakem yorumu, ayrı bir satır olarak çıkarılır, ve hakem kimliği ile yorumun yeri etiketlenir. Model, bu çıkarma işlemini destekler, uzun bir hakem raporunu ayrı yorumlara böler. Ardından her satıra, yazarın yanıtı ve planlanan değişiklik eklenir. Bu içerik, yazarın kendi analitik kararıdır, model yalnızca biçimi düzenler.

Burada kritik bir sınır vardır. Model, matrisin yapısını ve dilbilgisel düzenini destekler, ama yanıtın özünü yazar üretir. Bir hakem yorumuna ne yanıt verileceği, makalenin bilimsel içeriğine dair bir karardır, ve bu karar her zaman araştırmacınındır. Hosseini ve diğerleri (2023), bilimsel yayınların yazımında yapay zeka kullanımını ele alırken, aracın metni düzenlemesi ile metnin içeriğini üretmesi arasındaki ayrımın korunması gerektiğini vurgular. İzlenebilirlik matrisinde bu ayrım nettir. Biçim modelin desteğiyle, içerik yazarın kalemiyle.

## 4. Yapay Zeka İzinin Etik Tartışması

Yapay zeka ile yazılmış metinlerin izini gizleme tartışması, dikkatli bir ayrım gerektirir. Bir araştırmacı, yapay zeka yardımıyla yazdığı bir metni daha doğal görünür kılmak isteyebilir. Burada bir etik sınır vardır, ve bu sınır kolayca yanlış okunur. Yapay zeka yardımıyla yazılmış bir metin, yapay zeka tarafından yazılmış bir metin değildir. Bir araştırmacının kendi analizini yapay zeka desteğiyle daha açık ifade etmesi meşrudur. Ancak yapay zekanın ürettiği içeriği kendi üretimi gibi sunması meşru değildir.

Bu ayrım, anti-yapay-zeka-izi yazımının neden karmaşık olduğunu açıklar. Else (2023), yapay zeka tarafından yazılan özetlerin bilim insanlarını yanıltabildiğini gösterdiğinde, sorunun gizleme değil, ifşa eksikliği olduğu netleşti. Bir metnin yapay zeka izini taşıyıp taşımaması ikincil bir sorudur. Birincil soru, yapay zeka katkısının ifşa edilip edilmediğidir. Bu broşür, izini gizleme rehberi değildir. Aksine, ifşa zorunluluğunu koruyarak, yapay zeka yardımının dürüstçe nasıl belirtileceğini gösterir. Bütünlük, izin görünürlüğünde değil, katkının açıklanmasındadır.
...
Kategori sütunu, aynı zamanda editörün triyaj aracıdır. Bir editör matrise baktığında, kabul edilen yorumların çoğunlukta olduğunu görür ve revizyonun ciddiyetine güvenir. Asıl dikkat, kısmi ve reddedilen satırlara yönelir. Bu satırlar, yazarın en özenli gerekçeyi sunması gereken yerlerdir. Yukarıdaki yedinci satır, başlık önerisinin kısmen uygulandığı bir kısmi kabuldür. Burada yazar, hakemin endişesini neden tam karşılamadığını ve bunun yerine hangi orta yolu bulduğunu açıkça yazmalıdır. Bir kısmi kabul, geçiştirilirse ikinci turda yeniden gündeme gelir. Açık bir gerekçeyle sunulursa, editör çoğunlukla yazarın tarafını tutar. Matris, bu kritik satırları görünür kılarak yazarın enerjisini en çok ihtiyaç duyulan yere yönlendirir.

## 6. "Hakem Yanlış" Protokolü

Her hakem yorumu doğru ya da uygulanabilir değildir. Bazı yorumlar bir yanlış anlamadan kaynaklanır, bazıları makalenin kapsamı dışındadır, bazıları ise çelişkili olabilir. Bir hakem bir değişiklik isterken, diğeri tersini isteyebilir. Bu durumlarda yazarın bir protokole ihtiyacı vardır.

Temel kural, hiçbir yorumun reddedilmeden geçiştirilmemesidir. Bir yazar bir yorumu uygulamamaya karar verirse, bunu açıkça ve gerekçeyle belirtmelidir. Gerekçe, hakeme değil, bilimsel argümana dayanmalıdır. "Hakem yanılıyor" demek yerine, "bu noktada literatür şunu önermektedir" denir. Williams ve Bizup (2016), açıklık ve zarafet üzerine yazım derslerinde, bir argümanın gücünün tonunda değil, kanıtında olduğunu vurgular. Bir hakem yanlış olduğunda bile, yanıt saygılı ve kanıta dayalı kalır. Editör escalation eşiği şudur. İki hakem birbiriyle çelişiyorsa, ya da bir yorum makalenin temel tasarımına aykırıysa, yazar editöre doğrudan bir not yazarak yönlendirme ister. Bu, çatışmayı yazarın tek başına çözmeye çalışmasından daha güvenlidir.

## 7. Editör ile Etkili İletişim

Editör, hakem ile yazar arasındaki hakemdir, ve onunla iletişim ayrı bir disiplin gerektirir. Yanıt mektubuna eşlik eden kısa bir editör notu, sürecin akışını kolaylaştırır. Bu not, ana değişiklikleri üç ya da dört cümlede özetler, ve varsa hakemler arası çelişkileri editörün dikkatine sunar. Editör, ayrıntılı matrisi okumadan önce bu nottan genel bir resim edinir.

Sword (2017), başarılı akademisyenlerin nasıl yazdığını incelediği çalışmasında, akademik iletişimde netliğin ve zamanlamanın önemini gösterir. Editöre yazılan not, kısa, net ve zamanında olmalıdır. Uzun bir savunma değil, bir yol haritası sunar. Editör, yazarın revizyonu ciddiye aldığını ve süreci yönettiğini bu nottan anlar.
...
Bir revizyon, çoğunlukla bir süre sınırıyla gelir. Otuz, altmış ya da doksan gün. Bu süre, bir plana bağlanmazsa hızla tükenir. Örnek bir doksan günlük plan şu yapıdadır. İlk otuz gün, hakem raporlarının okunması, izlenebilirlik matrisinin kurulması ve büyük yapısal değişikliklerin planlanması. İkinci otuz gün, değişikliklerin makaleye uygulanması ve yanıt metinlerinin yazılması. Son otuz gün, matrisin tamamlanması, makalenin bir bütünlük okuması ve editör notunun hazırlanması.

Daha kısa süreler için, plan orantılı olarak sıkıştırılır. Önemli olan, sürenin bir matrise bağlanmasıdır, çünkü matris hem işin kapsamını hem ilerlemeyi görünür kılar. Bir yazar, matristeki tamamlanmış satır oranına bakarak, kalan süreyi gerçekçi bir şekilde değerlendirir.
