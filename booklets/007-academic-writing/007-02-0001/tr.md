...
Önceki kategori kasanın klasör mimarisini kurmuştu. Bu broşür, o kasaya giren her referansın bibliyografik temizliğini ele alır. Dijital Nesne Tanımlayıcı, yani DOI, ilk bakışta bir stil kılavuzunu tatmin etmek için künyenin sonuna eklenen bir karakter dizisi gibi görünebilir. Değil. Üretici dil modellerinin bibliyografik açıdan inandırıcı ama hiç var olmamış atıflar üretebildiği bir dönemde DOI, araştırmacının elindeki en hızlı ampirik testtir: atıf gerçekse DOI'si çözülür, DOI çözülmüyorsa atıf yoktur. Bu broşür o testi, Claude Code iş akışında bir kez kurulan ve her manuskriptte yeniden kullanılan bir doğrulama protokolüne dönüştürür.
...
APA 7, DOI'yi olabildiğinde zorunlu kılar. Yedinci baskıdan önce isteğe bağlı olan bu kural APA 7 ile birlikte standart hale geldi. Değişimin ardında teknik bir gerekçe yok: gerekçe epistemolojiktir. Uluslararası Tıp Dergisi Editörleri Komitesi de (2024) bilimsel çalışmanın yürütülmesi ve raporlanmasına ilişkin önerilerinde atıf doğruluğunu yazarın temel sorumluluklarından biri olarak tanımlar. DOI bu sorumluluğu pratiğe taşır. Crossref'te çözülen bir DOI, söz konusu atıfın var olduğunun kanıtıdır. Çözülmeyen bir DOI, referans listesine girmemesi gereken bir kaydın işaretidir.

## 2. Yapay Zekâ ve Hayali Atıf, Ampirik Kanıtlar

DOI disiplininin neden bu kadar kritik olduğunu görmek için üretici yapay zekâ modellerinin atıf davranışına bakmak gerekir. Bu modeller, gerçek görünen ama var olmayan atıflar üretebilir. Bir görüş değil, ölçülmüş bir olgudur bu.
...
Doğrulama disiplini gerçek değerini, bir kez kurulan ve her manuskriptte yeniden kullanılan bir protokole dönüştüğünde kazanır. Aşağıdaki sekiz adım o protokolün iskeletidir.
...
DOI olmayan kaynaklar için temel kural şudur: doğrulama başka bir kalıcı tanımlayıcıya dayanmalıdır. ISBN, kurumsal arşiv URL'si ya da kütüphane kaydı. Önemli olan, atıfın gerçekliğinin orijinal iddiadan bağımsız bir kaynaklarca teyit edilmesidir. APA 7 (American Psychological Association, 2020) bu kaynak türleri için ayrı künye biçimleri tanımlar. DOI disiplini ise bu biçimlerden bağımsızdır. Disiplin stilde değil, doğrulama eyleminin kendisindedir.
...
**Broşür kimliği.** `007-02-0001`
**Sürüm.** `0.1.0`
**Tarih.** 2026-06-04
**Sözcük sayısı (yaklaşık).** 1936 (Türkçe gövde metni, wc ile ölçüldü)
**Doğrulanmış atıf sayısı.** 10
**Halüsinasyon atıf sayısı.** 0
**Önceki broşür.** [`004-01-0001`](../../004-vault-architecture/004-01-0001/tr.md). Klasör Disiplini ve Maps of Content (MOC) Kalıbı
