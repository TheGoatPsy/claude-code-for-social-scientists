...
- `CATALOG.md` status of 007-02-0001, 009-01-0001, and 010-01-0001 moved from `planned` to `paired`. Paired count 6 to 9, planned count 24 to 21. CATALOG titles for 009-01-0001 and 010-01-0001 aligned to the booklet frontmatter.
