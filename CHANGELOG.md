...
- v1.0 announcement scope reduced from thirty booklets to ten core booklets. The ten v1.0 booklets are marked `[v1.0]` in `CATALOG.md`. The remaining twenty booklets move to the v1.5 and v2.0 backlog. Rationale: quality over breadth for the v1.0 manifesto. `meta/roadmap.md` revised end-to-end (Phase 1 to Phase 3, v1.0, v1.5, v2.0 sections). Specific release dates removed from the roadmap and READMEs; release timing is set when the ten v1.0 booklets are reviewed and tagged.
